...
<div class="relative z-50" role="menu" tabindex="-1" onmouseleave={hidePanel}>
    ...
    <div id="light-dark-panel" class="hidden lg:block absolute transition float-panel-closed top-11 -right-2 pt-5" >
        <div class="card-base float-panel p-2">
            ...
            >
                <Icon icon="line-md:moon-alt-to-sunny-outline-loop-transition" class="text-[1.25rem] mr-3"></Icon>
            ...
            >
                <Icon icon="line-md:sunny-outline-to-moon-alt-loop-transition" class="text-[1.25rem] mr-3"></Icon>
            ...
            >
                <Icon icon="line-md:paint-drop-half-filled" class="text-[1.25rem] mr-3"></Icon>
