...
export function GithubCardComponent(properties, children) {
  ...
  const nTitle = h(`div`, { class: "gc-titlebar" }, [h("div", { class: "gc-titlebar-left" }, [h("div", { class: "gc-owner" }, [nAvatar, h("div", { class: "gc-user" }, repo.split("/")[0])]), h("div", { class: "gc-divider" }, "/"), h("div", { class: "gc-repo" }, repo.split("/")[1])]), h("div", { class: "github-logo" })]);
