...
export function LinkCardComponent(properties, children) {
  if (Array.isArray(children) && children.length !== 0) return h("div", { class: "hidden" }, ['Invalid directive. ("linkcard" directive must be leaf type "::linkcard{url="https://example.com"}")']);

  if (!properties.url) return h("div", { class: "hidden" }, 'Invalid URL. ("url" attribute must be provided in the format "https://example.com")');
  ...
  return h(
    ...
    [
      h("div", { class: "flex justify-between items-center" }, [
        h("div", { class: "text-left" }, [h("div", { class: "text-xl line-clamp-1" }, nTitle), h("div", { class: "font-normal mt-1 line-clamp-1" }, nDescription)]),
        h(
          "svg",
          {
